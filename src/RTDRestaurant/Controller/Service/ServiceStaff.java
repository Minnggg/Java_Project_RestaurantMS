...
public class ServiceStaff {
    ...
    public ModelNhanVien getStaff(int userID) throws SQLException {
        ...
        String sql = "SELECT ID_NV, TenNV, DATE_FORMAT(NgayVL, '%d-%m-%Y') AS Ngay, "
                + "SDT, Chucvu, ID_NQL FROM NhanVien WHERE ID_ND=?";
    ...
    public ModelHoaDon FindHoaDonbyID_Ban(ModelBan table) throws SQLException {
        ...
        String sql = "SELECT ID_HoaDon, ID_KH, ID_Ban, DATE_FORMAT(NgayHD, '%d-%m-%Y') AS Ngay, "
                ...
                + "FROM HoaDon WHERE ID_Ban=? AND Trangthai='Chua thanh toan'";
